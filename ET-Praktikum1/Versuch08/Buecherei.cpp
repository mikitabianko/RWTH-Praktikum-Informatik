...
int main()
{
    ...
    do  // Anzeige des Menüs
    {
        ...
        switch (abfrage)
        {
            ...
            //////////////////////////////////////
            // Alle verliehenen Medien ausgeben //
            //////////////////////////////////////
            case '6':
            {
...
///////////////////////////////////////////////////////////////
// Funktion gibt alle ausgeliehenen Medien der Datenbank aus //
///////////////////////////////////////////////////////////////
void ausgelieheneMedienAusgeben(std::vector<Medium*>& medien)
{
    bool mediumAusgeliehen = false;

    std::cout << "Ausgeliehene Medien in der Bücherei:" << std::endl;

    for (unsigned int index = 0; index < medien.size(); index++)
    {
        if (medien[index]->istAusgeliehen())
        {
            std::cout << "*************************************************************" << std::endl;
    ...
    if (!mediumAusgeliehen)
    {
        std::cout << "Zurzeit ist kein Medium ausgeliehen." << std::endl;
    }
}
